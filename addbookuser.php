...
$query="insert into book(bookname,authorname,category,booklang,bookimage,purchasedate,bookcondition,quantity,price,description,status,username) values('$bookname','$authorname','$category','$booklang','$image','$purchasedate','$bookcondition','$quantity','$price','$description','$status','$un')";
$n = my_iud($query);

if($n==1)
{
echo '<script>alert("Book Added Successfully");
window.location = "viewmybook.php";
</script>';
}
}
