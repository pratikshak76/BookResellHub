...
<div>
				...
				<div class="container">
				    <div class=row>
				        <div class="col-sm-12">
  <h2 class = text-center style = "color : blue">View My Bookings</h2>
...
$query = "select * from booking where customername='$u'";
$rs = my_select($query);
...
echo '<td><a href="deleteBooking.php?id='.$column['bookid'].'">
